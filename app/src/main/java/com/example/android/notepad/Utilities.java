...
public class Utilities {
    ...
    public static boolean saveNote(Context context, Note note) {
        ...
        try{
            fos = context.openFileOutput(fileName, context.MODE_PRIVATE); // tahame seda private mode’is
    ...
    static ArrayList<Note> getAllSavedNotes(Context context) {
        ...
        // read objects and add to list of notes. A FileInputStream obtains input bytes from a file
        // in a file system. An ObjectInputStream deserializes primitive data and objects previously
